    ...
    <div className="space-y-6">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
        <TabsList className="grid w-full grid-cols-7">
          ...
          <TabsTrigger value="hotspots" disabled={!isApproved} className="flex items-center space-x-2">
            <Wifi className="h-4 w-4" />
            <span>Hotspots</span>
          </TabsTrigger>
          <TabsTrigger value="packages" disabled={!isApproved} className="flex items-center space-x-2">
            <Package className="h-4 w-4" />
            <span>Packages</span>
          </TabsTrigger>
          <TabsTrigger value="dashboard" disabled={!isApproved} className="flex items-center space-x-2">
            <BarChart3 className="h-4 w-4" />
            <span>Sales</span>
          </TabsTrigger>
          <TabsTrigger value="sessions" disabled={!isApproved} className="flex items-center space-x-2">
            <Users className="h-4 w-4" />
            <span>Sessions</span>
          </TabsTrigger>
          <TabsTrigger value="payouts" disabled={!isApproved} className="flex items-center space-x-2">
